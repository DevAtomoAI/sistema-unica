...
<head>
    ...
    <link rel="stylesheet" href="aprovadas.css">
    <title>Página aprovadas</title>
</head>
            ...
            <div class="searchItens">
                <form action="configs_andamento.php" method="POST">
                    <div class="search-container">
                        ...
                        <button class='filtrosPesquisa' id="btn" idtype="submit" name="pesquisaValoresAprovadas" id="pesquisaValoresAprovadas"><img src="assets/lupa.svg" alt=""> Pesquisar</button>
                    </div>
                </form>
            </div>
