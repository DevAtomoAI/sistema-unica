...
function adicionarLinhaPeças() {
    ...
    novaLinha.insertCell(8).innerHTML = '<button onclick="removerLinha(this)">Excluir</button>';
...
function adicionarLinhaServicos() {
    ...
    novaLinha.insertCell(6).innerHTML = '<button onclick="removerLinha(this)">Excluir</button>';
}
