        ...
        <div class="search-bar">
            <form action="configs_faturadas.php" method="POST">
                ...
                <select name="centro-custo">
                    ...
                    <?php
                    $selectTableOrgaosSolicitantes = "SELECT * FROM infos_veiculos_inclusos WHERE orcamento_aprovada_reprovada_oficina='Faturada Oficina' ORDER BY id_infos_veiculos_inclusos ASC";
