    ...
    <div class="search-bar">
        <form action="configs_responder.php" method="POST">
            ...
            <select name="centro-custo">
                ...
                <?php
                $selectTableOrgaosSolicitantes = "SELECT * FROM infos_veiculos_inclusos WHERE opcao_aprovada_reprovada_oficina='Respondida' ORDER BY id_infos_veiculos_inclusos ASC";
