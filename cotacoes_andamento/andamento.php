...
$selectTableEmAndamento = "SELECT * FROM infos_veiculos_inclusos WHERE opcao_aprovada_reprovada_oficina='' ORDER BY id_infos_veiculos_inclusos ASC";
                    ...
                    <?php
                        foreach ($cotacoes as $cotacao) {
                            ...
                            echo "<td class='resultadosTabela'>
                                <form method='POST' action='../gerenciar_cotacoes/gerenciar.php'>
